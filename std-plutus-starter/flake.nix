...
{
  description = "Plutus Starter (Attempt to Wire in Std/Paisano)";
  ...
  outputs = inputs:
    ...
    inputs.std.growOn
      ...
      # The attrs will be recursively merged in the order in which they appear.
      {
        ...
        devShells = inputs.std.harvest inputs.self [ "plutus-starter" "devshells" ];
        ...
        packages = inputs.std.harvest inputs.self [ "plutus-starter" "packages" ];
      }
      {
